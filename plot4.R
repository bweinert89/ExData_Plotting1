...
#Top left Panel
with(dt2,plot(DateTime,Global_active_power,xlab=" ",ylab="Global Active Power",type="l"))

#Top right panel
with(dt2,plot(DateTime,Voltage,xlab="datetime",ylab="Voltage",type="l"))
...
#Add legend (additional bty = n to remove line around legend)
legend("topright",legend=c("Sub_metering_1","Sub_metering_2","Sub_metering_3"),
       col=c("black","red","blue"),lty=1,lwd=2,bty="n")

#Bottom right panel
with(dt2,plot(DateTime,Global_reactive_power,xlab="datetime",type="l"))
